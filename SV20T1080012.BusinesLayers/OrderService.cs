...
namespace SV20T1080012.BusinessLayers
{
    public static class OrderService
    {
        ...
        public static bool CancelOrder(int orderID)
        {
            ...
            // Kiểm tra xem việc hủy bỏ đơn hàng có hợp lý đối với trạng thái hiện tại của đơn hàng hay không?
            //... Your code here ...
        ...
        public static bool RejectOrder(int orderID)
        {
            ...
            // Kiểm tra xem việc từ chối đơn hàng có hợp lý đối với trạng thái hiện tại của đơn hàng hay không?
            //... Your code here ...
        ...
        public static bool AcceptOrder(int orderID)
        {
            ...
            // Kiểm tra xem việc chấp nhận đơn hàng có hợp lý đối với trạng thái hiện tại của đơn hàng hay không?
            //... Your code here ...
        ...
        public static bool ShipOrder(int orderID, int shipperID)
        {
            ...
            //Kiểm tra xem việc xác nhận đã chuyển hàng có hợp lý đối với trạng thái hiện tại của đơn hàng hay không?
            //... Your code here ...
